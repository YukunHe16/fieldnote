...
type LearningConfirmStore = Pick<
  LearningStore,
  "confirmVerification" | "getIncident" | "getSessionForIncident" | "maybeCreatePendingPolicyRevision"
>;
...
export function confirmLearningVerification(
  deps: { learning: LearningConfirmStore; store: ConversationLookup; events: EventStore },
