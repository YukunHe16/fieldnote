...
export type AdmissionsProgramStatus =
  | "researching"
  | "shortlisted"
  | "applying"
  | "submitted"
  ...
  | "rejected"
  | "withdrawn";
export type AdmissionsRequirementStatus = "missing" | "in_progress" | "ready" | "submitted" | "waived";
...
export interface AdmissionsProgramDeadline {
  id: string;
  label: string;
  dueAt: string;
}
...
export interface AdmissionsProgram {
  ...
  country?: string;
  degree?: string;
  status?: AdmissionsProgramStatus;
  officialUrl?: string;
  deadline?: string | null;
  deadlines?: AdmissionsProgramDeadline[];
...
export interface AdmissionsRequirement {
  ...
  title: string;
  type?: string;
  status?: AdmissionsRequirementStatus;
  dueAt?: string | null;
  notes?: string;
...
export interface AdmissionsArtifact {
  id: string;
  title: string;
  kind?: string;
  status?: string;
